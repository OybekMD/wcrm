...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/productimage/": {
            "post": {
                "description": "Api for creating a new ProductImage",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "ProductImage information for creating a new ProductImage",
                        "name": "ProductImage",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ProductImageReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully created ProductImage",
                        "schema": {
        ...
        "/v1/productimage/{id}": {
            "get": {
                "description": "Api for getting a ProductImage by ID",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved ProductImage",
                        "schema": {
                            "$ref": "#/definitions/models.ProductImage"
                        }
                    },
            ...
            "put": {
                "description": "API for updating ProductImage by id",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "ProductImage object to update",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ProductImageUpdate"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                "description": "API for deleting ProductImage by id",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/v1/productimages/": {
            "get": {
                ...
                "description": "Api returns list of ProductImages",
                "consumes": [
                    "application/json"
                ],
                "produces": [
